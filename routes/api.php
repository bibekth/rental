...
Route::controller(AuthController::class)->group(function(){
    ...
    Route::post('logout','logout')->middleware('api_check');

});
// login garey si auni vaye chai yesto rakhna parcha
// Route::controller(HomeController::class)->middleware('api_check', 'role:user|admin')->group(function(){
// Route::controller(HomeController::class)->middleware('api_check')->group(function(){
    // natra yo
...
Route::controller(CommentController::class)->middleware('api_check')->group(function () {
...
Route::controller(OrderController::class)->middleware('api_check')->group(function () {
...
Route::controller(OrderDetailController::class)->middleware('api_check')->group(function () {
...
Route::middleware('api_check')->controller(WishlistController::class)->group(function () {
...
Route::middleware('api_check')->controller(OrderController::class)->group(function () {
